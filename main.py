...
def example1():
        ...
        #
        # power_plant_inflow = Inflow("inflow", power_plant, 1000)
        ...
        water_management_system = WaterManagementSystem(
                ...
                [power_plant], {"ethiopia_power": 0}

        )
        action = water_management_system.action_space.sample()
        print(action)
        water_management_system.step(action)
        print(water_management_system._determine_info()["water_systems"][0].determine_info())
